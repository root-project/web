...
permalink: /404.html
---
<!-- Doc latest-stable redirect -->
<script src='/doc/versions.js'></script>
<script>
    if (window.location.pathname.startsWith("/doc/latest-stable/")) {
        let real_url = window.location.href.replace("latest-stable", `v${LATEST_STABLE}`);
